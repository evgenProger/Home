...
public class Solution {
    ...
    public static  void main(String[] args) {
        ...
        UntrustworthyMailWorker untrustwothyMailWorker = new UntrustworthyMailWorker(variousWorkers);
        ...
        Arrays.stream(correspondence).forEach(parcels -> {
            try {
                untrustwothyMailWorker.processMail(parcels);
            ...
            } catch (MyClass.IllegalPackageException e) {
                e.printStackTrace();
            } catch (MyClass.StolenPackageException e) {
                e.printStackTrace();
            }
        });
